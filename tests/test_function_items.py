...
def test_function_basic_py_to_yaml() -> None:
    ...
    d = _res_dir("function")
    py = (d / "basic_function.py.txt").read_text(encoding="utf-8")
...
def test_function_basic_yaml_to_py() -> None:
    ...
    expected_code = (d / "basic_function.py.txt").read_text(encoding="utf-8").strip()
...
def test_function_complex_py_to_yaml() -> None:
    ...
    d = _res_dir("function")
    py = (d / "complex_function.py.txt").read_text(encoding="utf-8")
...
def test_function_complex_yaml_to_py() -> None:
    ...
    expected_code = (d / "complex_function.py.txt").read_text(encoding="utf-8").strip()
